...
**Pause at 15:38, before "which direction did you sort".** That is the moment
worth setting up: tell them your instruction said *sort the treated patients*
and did not say which way, then let it play.
...
**1:22 — before it answers.** It has been told not to fix anything. Say that
...
**59:36 — four at once.** The picture, not the reviews. Four independent
reviewers, none able to see the others, none allowed to read the course
material.

---

## If the room asks a question you want to answer from the recording

| question | jump to |
|---|---|
| "How did it know which file was which system?" | 5:45 |
| "Did it lose any patients?" | 8:24 |
| "How do you know it isn't just the analysis that worked?" | 32:10 |
| "Would it catch its own mistakes?" | 59:36, then 60:43 |
| "What about the numbers in the paper?" | 45:05, play one minute |
