...
<p class="subtitle">Driving an AI coding agent end&#8209;to&#8209;end — from ten messy hospital exports to a typeset, machine&#8209;audited manuscript.</p>
...
- <span class="ic ic-shuffle"></span> **Current step**
  ...
  - Median HR **0.583**, IQR 0.560–0.608, range 0.515–0.699
- <span class="ic ic-message"></span> **Good prompt**
...
- <span class="ic ic-alert"></span> **Report the honest number**
  - Only **66%** of specifications land in 0.55–0.61
...
- <span class="ic ic-flask"></span> **Current step**
  ...
  - **RD −0.150 (−0.221 to −0.078)** — a different target, same direction
- <span class="ic ic-message"></span> **Good prompt**
